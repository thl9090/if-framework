package com.yx.wx.server.aspect;
...
public class LogAspect {
    ...
    @Pointcut("execution(* *..controller..*.*(..)) && @annotation(com.yx.wx.server.annotation.SysLogOpt)")
        ...
        try {
            ...
            if (Constants.LogOptEnum.QUERY.value() != sysLogModel.getOperationType()) {
                if (logAfter(result, sysLogModel).getUserName() != null) {
                    ...
                    sysLogModel.setSource(UserSourceEnum.WX.getStatus());

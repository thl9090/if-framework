package com.yx.admin.server.shiro.realm;
...
public class SysUserRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        SysUser sysUserModel = sysUserService.selectByAccount(usernamePasswordToken.getUsername());
        if (null == sysUserModel) {
            throw new UnknownAccountException();
        }
        if(!SysUserEnableEnum.YES.getStatus().equals(sysUserModel.getEnable())){

package com.yx.api.server.aspect;
...
public class LogAspect {
    ...
    @Pointcut("execution(* *..controller..*.*(..)) && @annotation(com.yx.api.server.annotation.SysLogOpt)")
        ...
        try {
            ...
            if (Constants.LogOptEnum.QUERY.value() != sysLogModel.getOperationType()) {
                if (logAfter(result, sysLogModel).getUserName() != null) {
                    ...
                    sysLogModel.setSource(UserSourceEnum.API.getStatus());

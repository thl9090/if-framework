    ...
    var tableIns = table.render({
        ...
        cols: [[
            {type: 'checkbox', fixed: 'left'},
                {field: 'productId', title: '标的id'},
                {field: 'firstCheckStatus', title: '初审状态：1、审核通过；0、不通过'},
                {field: 'firstCheckRemark', title: '初审描述'},
                {field: 'finalCheckStatus', title: '终审状态'},
                {field: 'finalCheckRemark', title: '终审描述'},

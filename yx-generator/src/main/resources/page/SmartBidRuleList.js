    ...
    var tableIns = table.render({
        ...
        cols: [[
            {type: 'checkbox', fixed: 'left'},
                {field: 'smartBidPlanId', title: '智投计划id(smart_bid_plan表id)'},
                {field: 'borrowDeadline', title: '借款期限'},
                {field: 'profit', title: '年化利率'},
                {field: 'addProfit', title: '加息利率'},
                {field: 'repurchaseMode', title: '还款方式'},
                {field: 'lockDeadline', title: '锁定期限'},
                {field: 'minApplyAmount', title: '最小加入金额'},
                {field: 'maxApplyAmount', title: '最大加入金额'},
                {field: 'applyFee', title: '加入费用'},

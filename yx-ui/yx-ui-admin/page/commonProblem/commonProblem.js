layui.config({
    ...
    var base = layui.base,
        ...
        submitUrl = parent.pageOperation === 1?"sysCommonProblem/add":"sysCommonProblem/update";
    ...
    if(parent.pageOperation === 0 || parent.pageOperation === 2) {
        ...
        $.ajax({
            type: "GET",
            url: "sysCommonProblem/select/"+parent.dataId,
    ...
    if(parent.pageOperation===1 || parent.pageOperation===2) {
        ...
        form.on("submit(adddept)",function(data){
            ...
            if(parent.pageOperation===2){
                // data.field.content=$("#LAY_layedit_17").contents().find("body").html();

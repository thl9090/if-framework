layui.config({
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'opt', title: '操作', fixed: 'right', width: 220, align: 'center', toolbar: '#toolBar'}
        ]],
        url: 'product/selectFirstPage',
        method: 'post',
        ...
        if (layEvent === 'detail') { //查看
            ...
            var index = layui.layer.open({
                ...
                success: function (layero, index) {
                    setTimeout(function () {
                        layui.layer.tips('点击此处返回标的初审列表', '.layui-layer-setwin .layui-layer-close', {
                            tips: 3
                        });
                    }, 500)
                }
            ...
            var dataIds = [data.idlayEvent === 'del'];
            ...
            var index = layui.layer.open({
                ...
                type: 2,
                area:['70%','70%'],
                content: "productFirstCheck.html",
                success: function (layero, index) {
                    setTimeout(function () {

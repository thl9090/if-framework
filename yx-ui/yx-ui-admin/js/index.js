...
layui.config({
    ...
    //渲染用户名和头像
    var currentUser = layui.data("yx_UMP").CUURENT_USER;
    if (typeof(currentUser) === "undefined") {
        window.location.href = "/page/login/login.html";
    }
    var userName = layui.data("yx_UMP").CUURENT_USER.userName;
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code === 200) {
                ...
                window.sessionStorage.setItem("yx_UMP_USER_PERMISSIONS", data.data);
            }
        },
    ...
    function lockPage() {
        layer.open({
            ...
            '<div class="admin-header-lock-img"><img src="images/logo.png"/></div>' +
            '<div class="admin-header-lock-name" id="lockUserName">yx</div>' +
            '<div class="input_btn">' +
